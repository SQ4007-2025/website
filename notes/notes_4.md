...
* You can imagine an image as a map of bits, where zeros represent black and ones represent white.
  ...
  ![Zeros and ones being converted to a black and white smiley](notes/images/week_4/cs50Week4Slide015.png)
...
* *RGB*, or *red, green, blue*, are numbers that represent the amount of each of these colors. In Adobe Photoshop, you can see these settings as follows:
  ...
  ![A photoshop panel with RGB values and hexadecimal input](notes/images/week_4/cs50Week4Slide016.png)
...
* In weeks past, you may recall our artist rendering of concurrent blocks of memory. Applying hexadecimal numbering to each of these blocks of memory, you can visualize these as follows:
  ...
  ![Blocks of memory numbered in hex](notes/images/week_4/cs50Week4Slide065.png)
* You can imagine how there may be confusion regarding whether the `10` block above may represent a location in memory or the value `10`. Accordingly, by convention, all hexadecimal numbers are often represented with the `0x` prefix as follows:
  ...
  ![blocks of memory numbered in hex with 0x](notes/images/week_4/cs50Week4Slide066.png)
...
* You can visualize how this program stores this value as follows:
  ...
  ![the value 50 stored in a memory location with hex](notes/images/week_4/cs50Week4Slide070.png)
...
* You can visualize our code as follows:
  ...
  ![Same value of 50 in a memory location with a pointer value stored elsewhere](notes/images/week_4/cs50Week4Slide078.png)
...
* You can more accurately visualize a pointer as one address that points to another:
  ...
  ![A pointer as an arrow, pointing from one location of memory to another](notes/images/week_4/cs50Week4Slide079.png)
...
* Recall that a string is simply an array of characters. For example, `string s = "HI!"` can be represented as follows:
  ...
  ![The string HI with an exclamation point stored in memory](notes/images/week_4/cs50Week4Slide085.png)
* However, what is `s` really? Where is the `s` stored in memory? As you can imagine, `s` needs to be stored somewhere. You can visualize the relationship of `s` to the string as follows:
  ...
  ![Same string HI with a pointer pointing to it](notes/images/week_4/cs50Week4Slide086.png)
...
* Why are these strings seemingly different? You can use the following to visualize why:
  ...
  ![two strings stored separately in memory](notes/images/week_4/cs50Week4Slide115.png)
...
* You can visualize the above code as follows:
  ...
  ![two pointers pointing at the same memory location with a string](notes/images/week_4/cs50Week4Slide124.png)
...
* Consider the following image:
  ...
  ![a rectangle with machine code at top followed by globals heap and stack](notes/images/week_4/cs50Week4Slide163.png)
...
* Now, consider the following image:
  ...
  ![a rectangle with main function at bottom and swap function directly above it](notes/images/week_4/cs50Week4Slide167.png)
...
* You can visualize this as follows:
  ...
  ![a and b stored in main function being passed by reference to the swap function](notes/images/week_4/cs50Week4Slide198.png)
...
* We can implement our own copy program by typing `code cp.c` and writing code as follows:
  ...
  Notice that this file creates our own data type called a BYTE , which is the size of a uint8\_t. Then, the file reads a `BYTE` and writes it to a file.
