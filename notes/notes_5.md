...
-   You can create a file called `phonebook.csv` in advance of running the above code or download [phonebook.csv](https://github.com/SQ4007-2025/website/raw/refs/heads/master/data/phonebook.csv). After running the above program and inputting a name and phone number, you will notice that this data persists in your CSV file.
