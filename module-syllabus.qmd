...
**Flipped classroom** will be used exclusively for this module. This reverses traditional teaching by having students go through new material independently—through videos or readings—before class, then using class time for discussion, problem-solving, assessments, and applying ideas. This lets students work through content at their own pace and ensures that support from teachers and peers is available when tackling challenging concepts. The idea is to make learning more active, collaborative, and confidence-building. Also, it is usually more fun than traditional lectures!
